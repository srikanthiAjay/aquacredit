$(document).ready(function() {
    ...
    $("#skey").autocomplete({
        ...
        select: function(event, ui) {
            ...
            if (ui.item.user_type == "NON_FARMER") {
                ...
                $(".sel_loc").hide();
            } else { $('input[name="crop_opt"]').prop('required', true);
                $(".sel_loc").show(); }
    ...
    $("input[name='month_opt']").on('click', function() {
        ...
        if (date_val == "custom") { $(".cdate").show(); } else { $(".cdate").hide();
            tables.draw(); }
