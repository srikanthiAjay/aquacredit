	...
	public function add()
	{
		...
		if($_POST["sale_types"]=='cash')
		{
			$data = array(
				...
				"amount_type"	=>	"OUT",//
				"description"	=>	"Cash Sale Goads Sent",//
				"status"		=>	"0",//
		...
		else
		{
			$data = array(
				...
				"amount"		=>	$this->input->post("totamtval"),//
				"amount_type"	=>	"OUT",//
				"description"	=>	"Credit Sale Goads Sent",//
				"status"		=>	"0",//
				"created_by"	=>	$this->session->userdata('adminid'),//
			);
			$this->Transaction_model->insert($data);
	...
	public function update()
	{
		...
		if($_POST["sale_types"]=='cash')
		{
			$data = array(
				...
				"amount"		=>	$this->input->post("totamtval"),//
				//"amount_type"	=>	"OUT",//
				"description"	=>	"Cash Sale Goads Sent updated",//
				"status"		=>	"0",//
				"updated_by"	=>	$this->session->userdata('adminid'),//
			);
			$this->Transaction_model->update($data,array('trans_type' => 'SALE', 'trans' => 'GOADS', 'trans_id' => $saleid));
		...
		else
		{
			$data = array(
				...
				"amount"		=>	$this->input->post("totamtval"),//
				"amount_type"	=>	"OUT",//
				"description"	=>	"Credit Sale Goads Sent updated",//
				"status"		=>	"0",//
				"updated_by"	=>	$this->session->userdata('adminid'),//
			);
			$this->Transaction_model->update($data,array('trans_type' => 'SALE', 'trans' => 'GOADS', 'trans_id' => $saleid));
