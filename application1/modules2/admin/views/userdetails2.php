  	...
  	<div class="sle_cr_r">
		...
		<div class="urs_dt">
			<div class="">
				...
				<div id="table_footer"  style="width:100%">
	...
	var tables = $('#usr_lst_tbl').DataTable({
		...
		"footerCallback": function (tfoot, data, start, end, display) {
			...
			$footer_html ='<tr>'+
							...
							'</tr>';
							$("#usr_lst_tbl").append(
								$('<tfoot/>').append( $("#usr_lst_tbl thead tr").clone() )
								);
...
function load_settled()
{
	...
	var tables = $('#usr_lst_tbl').DataTable({
		...
		"columns": [
			...
			{title: "Status",className: "txt_rt out_td","width": "30%"},
			{title: "Download",className: "txt_rt out_td","width": "20%"},
		],
