...
<div class="right_blk">
	<div class="top_ttl_blk"> <span class="back_btn">
		...
		<a href="<?php echo base_url(); ?>admin/Companies/create" title="" class="fr btn btn-primary"> Create Company  </a>
	</div>
...
function popoverContent() {
	...
	content = content.replace(/view_it/g, 'admin/Companies/view/'+id);
	content = content.replace(/edit_it/g, 'admin/Companies/edit/'+id);
