...
<div class="side_menu"> 
	...
	<div class="menu_list">		
		<ul> 
			...
			<li> 
				<a href="<?php echo base_url();?>admin/Companies" title="" <?php if($page == "Companies") echo "class='act_menu'";?>> <i> <img src="<?php echo base_url();?>assets/images/brand.png"> </i> <span> Companies </span> </a>
			</li>
			<li> 
