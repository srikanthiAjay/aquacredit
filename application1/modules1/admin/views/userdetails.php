      ...
      <ul class="anl_tcs">
        ...
        <li class="bor_lf_none"> 
            <div class="top_in_op crop_top">
                   ...
                   <div class="rt_btm">
                     <button class="btn btn-primary stl_trn_his" data-toggle="modal" data-target="#settl_amnt">Settle Amount </button>
...
$('.dataTables_scrollBody').css('height', min_h);
    // $('#usr_lst_tbl_wrapper .dataTables_length').html('<h2 class="create_hdg lng_hdg"> Prudhvi PS - #AU000001 </h2>');
