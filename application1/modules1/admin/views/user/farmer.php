...
<div class="right_blk">
	...
	<div class="padding_30">
		<ul class="usrs_blk"> 
			<li class="far_act" id="far_icn"><a href="<?php echo base_url();?>admin/users/createfarmer"> <img src="<?php echo base_url();?>assets/images/f_1.png"><span>Farmer</span></a></li>
			<li id="dl_icn"><a href="<?php echo base_url();?>admin/users/createdealer"> <img src="<?php echo base_url();?>assets/images/f_2.png"><span>Dealer / Sub-Dealer</span></a></li>
			<li id="non_va_icn"><a href="<?php echo base_url();?>admin/users/createnonfarmer"> <img src="<?php echo base_url();?>assets/images/f_3.png"><span>Non-Farmer</span></a></li>
								...
								<div class="row">
									...
									<div class="col-md-4"> 
										<div class="form-group">
											...
											<input type="text" placeholder="Outstanding Amount" id="os_amt" name="os_amt" class="form-control" onkeypress="return allowNumerORDecimal(event,this)"> 
										</div>
									</div>
