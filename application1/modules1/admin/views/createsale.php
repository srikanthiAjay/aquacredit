		...
		<ul class="create_ul"> 
			...
			<li class="create_li ">
			 	<div class="cre_inp">
			    	...
			    	<input type="text" class="form-control mykey" onkeypress="return onlyNumberKey(event)" placeholder="" data-original-title="" title="" name="s_pincode" id="s_pincode">
				</div>
			 </li>
			...
			<table class="sa_lst" cellpadding="0" cellspacing="" border="0">
				...
				<tbody id="invoiceItem">
					...
					<tr id="rowNums0"> 
						...
						<td class="disc txt_rt"> <input type="text" onkeypress="return onlyNumberKey(event)" class="mykey" placeholder="0" name="prodisc[]" id="prodisc0" readonly> </td>
		...
		$.ajax({
		  ...
		  {           
			...
			{ 
				...
				window.location.href = "<?php echo base_url('api/sales/sale_invoice/11');?>";
				setTimeout(function() {
					location.reload();
				}, 2000);   
