...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="<?php echo base_url();?>assets/css/bootstrap-4.4.1.min.css">	
	...
	<link href="<?php echo base_url();?>assets/css/scroll.css" type="text/css" rel="stylesheet">
	<link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">
	<style> .error { color:red;}</style>
	<style>
		html, body, .main_cnt_blk{ height: 100%; }
	</style>
...
<!-- <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js"></script> -->
	...
	<script src="<?php echo base_url();?>assets/js/bootstrap-4.4.1.min.js"></script>
