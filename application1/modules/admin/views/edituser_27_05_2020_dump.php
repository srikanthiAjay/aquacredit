...
<div class="right_blk"> 
	...
	<div class="padding_30">
		...
		<?php $tot_meds = $med1 = $med2 = $med3 = "";
			if($udata["brands_yn"] == "Yes"){
				
				//$each_med = explode("#",$brandsdata["brands"]);
				$all_meds = explode("#",$brandsdata["brands"]);
				
				foreach($all_meds as $amed)
				{
					$each_med = explode(":",$amed);
					if($each_med[0]=="m1"){ $med1 = $each_med[1];}
					if($each_med[0]=="m2"){ $med2 = $each_med[1];}
					if($each_med[0]=="m3"){ $med3 = $each_med[1];}
				}
				$tot_meds = $med1.','.$med2.','.$med3;
			} ?>
				...
				<div class="row"> 
					<div class="col-md-12 lft_blk"> 
						<div class="pad_20">
							...
							<div class="row">
								<div class="col-md-4"> 
									<div class="form-group">
										...
										<input type="text" class="form-control" id="uname" name="uname" value="<?php echo $udata["uname"];?>" placeholder="Name">   
									</div>
								</div>
								...
								<div class="col-md-4"> 
									<div class="form-group">
										...
										<input type="text" class="form-control" id="guaran" name="guaran" value="<?php echo $udata["guarantor"];?>" placeholder="Guarantor(C/O)">   
									</div>
								</div>
								...
								<div class="col-md-4"> 
									<div class="form-group">
										...
										<input type="text" class="form-control allownumericwithoutdecimal" id="mob_numb" name="mob_numb" placeholder="Mobile Number" value="<?php echo $udata["mobile"];?>" onblur="checkmobile();">   
									</div>
								</div>
								...
								<div class="col-md-4"> 
									<div class="form-group">
										...
										<input type="email" class="form-control" id="email_id" name="email_id" value="<?php echo $udata["uemail"];?>" placeholder="Email Id">  
									</div>
								</div>
								...
								<div class="col-md-4"> 
									<div class="form-group">
										...
										<textarea   class="form-control" id="uaddr" name="uaddr" rows="2" placeholder="Address"><?php echo $udata["address"];?></textarea> 
									</div>
								</div>
							...
							<div class="alerts_confirm fl">
								<div class="alert_check <?php if($udata["notify_alert"]==0){ echo "check_ale"; }?>"> <input type="checkbox" id="turnchk" name="turnchk" value="<?php echo $udata["notify_alert"];?>" <?php if($udata["notify_alert"]==1){ echo "checked"; }?> > 
								...
								<div class="row">
									<div class="col-md-6"> 
										<div class="form-group new_blk">
											...
											<input type="text" class="form-control allownumericwithoutdecimal" id="mob_numb_new" name="mob_numb_new" placeholder="Mobile Number" value="" />
											<ul class="new_mob_em_blk new_p">
												<?php if(isset($udata["alert_mobile"])){ 
													$alert_mobiles = explode(",",$udata["alert_mobile"]);
													for($m=0;$m<count($alert_mobiles);$m++){ 
														if($m==0){?>
														<li class="new_cont defa_c"><?php echo $alert_mobiles[$m].",";?></li>
														<?php }else{ ?>
														<li class="new_cont"><?php echo $alert_mobiles[$m];?>
														<span class="cls_itm"><img src="<?php echo base_url().'assets/images/close_btn.png';?>" /> </span>
														</li>
												<?php } } }?>
											</ul> 
											<input type="hidden" id="hid_mob_nf" name="hid_mob_nf" value="<?php echo $udata["alert_mobile"];?>" class="multvals_nf" />
										</div>
									</div>
									...
									<div class="col-md-6"> 
										<div class="form-group new_blk">
											...
											<input type="email" class="form-control" id="email_id_new" name="email_id_new" placeholder="Email Id" />  
											<ul class="new_mob_em_blk new_m">
												<?php if(isset($udata["alert_email"])){ 
												$alert_emails = explode(",",$udata["alert_email"]);for($e=0;$e<count($alert_emails);$e++){ 
													if($e==0){?>
													<li class="new_cont defa_c"><?php echo $alert_emails[$e].",";?></li>
													<?php }else{ ?>
													<li class="new_cont"><?php echo $alert_emails[$e];?>
													<span class="cls_itm"><img src="<?php echo base_url().'assets/images/close_btn.png';?>" /> </span>
													</li>
												<?php } } }?>
											</ul> 
											<input type="hidden" id="hid_mail_nf" name="hid_mail_nf" value="<?php echo $udata["alert_email"];?>" class="multvals_nf" />	
										</div>
									</div>
							...
							<div class="row"> 
								<div class="col-md-4"> 
									<div class="form-group">
										...
										<input type="text" class="form-control" id="aadhar" name="aadhar" value="<?php echo $udata["aadhar"];?>" placeholder="Aadhar" />   
									</div>
								</div>
								...
								<div class="col-md-4"> 
									<div class="form-group">
										...
										<input type="text" class="form-control" id="pan" name="pan" value="<?php echo $udata["pan"];?>" placeholder="PAN" />   
									</div>
								</div>
								...
								<div class="col-md-4"> 
									<div class="form-group">
										...
										<input type="text" class="form-control" id="gst" name="gst"  value="<?php echo $udata["gst"];?>"placeholder="GST" />   
									</div>
								</div>
					...
					<div class="col-md-12"> 
						<div class="pad_20 bg_w">				 
							...
							<?php if(count($bankdata)>0){ $bankcount = count($bankdata);}else{ $bankcount = 0; } ?>
								<div class="hdg_bk">Bank Details(<?php echo $bankcount;?>) <a href="javascript:void(0)" title="" class="fr ad_bnk"> + Add Bank </a> </div>

								<div class="bank_list"> 
									<div class="bank_list_pos">
										<?php foreach($bankdata as $bdata){ ?>
										<div class="bank_dtl_blk">
											<span class="remove"> <img src="http://localhost/ac/assets/images/close_btn.png" alt="" title=""> </span>
											<div class="row">												
												<div class="col-md-6"> 
													<div class="form-group">
														<label for="fname">Person Full Name</label>
														<input type="text" class="form-control" id="fname" name="fname[]" value="<?php echo $bdata["holder_name"];?>" placeholder="Person Full Name" />   
													</div>
												</div>
												...
												<div class="col-md-6"> 
													<div class="form-group">
														...
														<input type="text" class="form-control allownumericwithoutdecimal" id="ac_number" name="ac_number[]" value="<?php echo $bdata["ac_number"];?>" placeholder="Account Number" />   
													</div>
												</div>

												<div class="col-md-6"> 
													<div class="form-group">
														<label for="bc_name">Bank Name</label>
														<input type="text" class="form-control" id="bc_name" name="bc_name[]" value="<?php echo $bdata["bank_name"];?>" placeholder="Bank Name" />  
													</div>
												</div>
												...
												<div class="col-md-6"> 
													<div class="form-group">
														...
														<input type="text" class="form-control" id="ifsc" name="ifsc[]" value="<?php echo $bdata["bank_ifsc"];?>" placeholder="IFSC" />
													</div>
												</div>
												...
												<div class="col-md-6"> 
													<div class="form-group">
														...
														<input type="text" class="form-control" id="branch_name" name="branch_name[]" value="<?php echo $bdata["branch_name"];?>" placeholder="Branch Name" />   
													</div>
												</div>												
											</div>
										</div>
							...
							<div class="row"> 
								<div class="col-md-4"> 
									<div class="form-group">
										...
										<input type="text " class="form-control" id="rate_of_int" name="rate_of_int" value="<?php echo $udata["roi"];?>" placeholder="Rate Of Interest"> 
									</div>
								</div>
							</div>
							...
							<div class="doc_up_lode"> 
								<div class="row"> 
									<div class="col-md-4"> 
										<div class="form-group">
											...
											<?php if(isset($udata["doc_type"]) && $udata["doc_type"] != "null"){ 	 $docs = explode(",",$udata['doc_type']); }?>
											<select id="docs_upld4" name="docs_upld4" multiple="multiple">
											<?php $adhsel = $pansel = $gstsel = $chqsel = $promsel = $gpsel = $stampsel = $pdsel = "";
											foreach($docs as $dval){ 
												if($dval=="aadhar"){ $adhsel = "selected";}
												if($dval=="pan"){ $pansel = "selected";}
												if($dval=="gst"){ $gstsel = "selected";}
												if($dval=="cheque"){ $chqsel = "selected";}
												if($dval=="promissory"){ $promsel = "selected";}
												if($dval=="gp"){ $gpsel = "selected";}
												if($dval=="stamp"){ $stampsel = "selected";}
												if($dval=="partnerdeed"){ $pdsel = "selected";}
											}?>
											<option value="aadhar" <?php echo $adhsel;?> >Aadhar</option>
											<option value="pan" <?php echo $pansel;?> >PAN</option>
											<option value="gst" <?php echo $gstsel;?> >GST</option>
											<option value="cheque" <?php echo $chqsel;?> >Cheque</option>
											<option value="promissory" <?php echo $promsel;?> >Promissory Note</option>
											<option value="gp" <?php echo $gpsel;?> >GP Document</option>
											<option value="stamp" <?php echo $stampsel;?> >Stamp Document</option>
											<option value="partnerdeed" <?php echo $pdsel;?> >Partnership Deed</option>													
										</select>
										</div>
									</div>
									...
									<div class="col-md-4"> 
										<div class="form-group">
											...
											<input type="date" id="recdate" name="recdate" value="<?php echo $udata["receive_date"];?>" placeholder="Documents Received Date" class="form-control" /> 
										</div>
									</div>
									...
									<div class="col-md-4"> 
										<div class="form-group">
											...
											<input type="date" id="retdate" name="retdate" value="<?php echo $udata["return_date"];?>" placeholder="Documents Return Date" class="form-control" /> 
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-4"> 
										<div class="form-group">
											<label for="rem">Remarks</label>
											<textarea class="form-control" id="doc_rem" name="doc_rem" rows="3" placeholder="Remarks"><?php echo $udata["doc_remarks"];?></textarea> 
										</div>
									</div>
								</div>
							</div>
							...
							<div class="hdg_bk">Outstanding Amount 
								...
								<option value="p" <?php if($udata["os_type"]=="p"){ echo "selected";}?> > + Additional Balance </option> 
								<option value="n" <?php if($udata["os_type"]=="n"){ echo "selected";}?>> - Negative Balance </option> 
							</select>
							</div>
							...
							<div class="row">
								...
								<div class="col-md-4"> 
									<div class="form-group">
										...
										<input type="text" placeholder="Outstanding Amount" id="os_amt" name="os_amt" value="<?php echo $udata["os_amt"];?>" class="form-control allownumericwithoutdecimal" /> 
									</div>
								</div>
								...
								<div class="col-md-4"> 
									<div class="form-group">
										<label for="rem">Remarks</label>
										<textarea class="form-control" id="os_rem" name="os_rem" rows="3" placeholder="Remarks"><?php echo $udata["os_remark"];?></textarea> 
									</div>
								</div>

							</div>
							<div class="form-group"> <button type="submit" class="btn btn-primary sub_btn" onclick="frmsbmt('nf');checkmobile();">Submit</button> </div>
						</div>
					</div>
				</div>
				<br/>
			...
			<form id="dealer" name="dealer" method="post" enctype="multipart/form-data" >
						...
						<div class="pad_20">
							...
							<div class="row">
								...
								<div class="col-md-4"> 
									<div class="form-group">
										...
										<input type="text" class="form-control" id="firm_name" value="<?php echo $udata["firm_name"];?>" name="firm_name" placeholder="Firm Name">   
									</div>
								</div>
								...
								<div class="col-md-4"> 
									<div class="form-group">
										...
										<input type="text" class="form-control" id="uname" name="uname" value="<?php echo $udata["uname"];?>" placeholder="Owner Name">   
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-6"> 
										<div class="form-group new_blk">
											...
											<input type="hidden" id="hid_mob_d" name="hid_mob_d" value="<?php echo $udata["alert_mobile"];?>" class="multvals_d" />
										</div>
									</div>
									...
									<div class="col-md-6"> 
										<div class="form-group new_blk">
											...
											<input type="hidden" id="hid_mail_d" name="hid_mail_d" value="<?php echo $udata["alert_email"];?>" class="multvals_d" />	
										</div>
									</div>
							...
							<div class="row">
								...
								<div class="col-md-4"> 
									<div class="form-group">
										<label for="name">Aadhar </label>
										<input type="text" class="form-control allownumericwithoutdecimal" id="aadhar" name="aadhar" value="<?php echo $udata["aadhar"];?>" placeholder="Aadhar">   
									</div>
								</div>
				...
				<?php if(count($bankdata)>0){ $bankcount = count($bankdata);}else{ $bankcount = 0; } ?>
						...
						<div class="row">
							...
							<input type="text" class="form-control" id="feed" value="<?php echo $udata["feed_per"];?>" placeholder="Feed" />   
							</div>
							</div>
							...
							<div class="col-md-4"> 
								<div class="form-group">
									...
									<input type="text" class="form-control" id="med1" name="med1" value="<?php echo $udata["med1_per"];?>" placeholder="Medicines1" />
									<input type="hidden"  id="hidd1" name="hidd1" value="<?php echo $med1;?>" />
								</div>
							</div>
							...
							<div class="col-md-4"> 
								<div class="form-group">
									...
									<input type="text" class="form-control" id="med2" name="med2" value="<?php echo $udata["med2_per"];?>" placeholder="Medicines2" />
									<input type="hidden"  id="hidd2" name="hidd2" value="<?php echo $med2;?>" />									
								</div>
							</div>
							...
							<div class="col-md-4"> 
								<div class="form-group">
									...
									<input type="text" class="form-control" id="med3" name="med3" value="<?php echo $udata["med3_per"];?>" placeholder="Medicines3" />
									<input type="hidden"  id="hidd3" name="hidd3" value="<?php echo $med3;?>" />									
								</div>
							</div>
						...
						<div class="form-group"> <button type="submit" class="btn btn-primary sub_btn" onclick="frmsbmt('d');checkmobile();">Submit</button></div>
						</div>
					</div>
				</div>
				<br/>
			...
			<div id="former">
					...
					<div class="row"> 
							...
							<div class="pad_20">
								...
								<div class="row">
									...
									<div class="col-md-4"> 
										<div class="form-group">
											<label for="name">Firm Name</label>
											<input type="text" class="form-control" id="firm_name" name="firm_name" value="<?php echo $udata["firm_name"];?>" placeholder="Firm Name">   
										</div>
									</div>
									...
									<div class="col-md-4"> 
										<div class="form-group">
											<label for="name">Address</label>
											<textarea   class="form-control" id="uaddr" name="uaddr" placeholder="Address" rows="2"><?php echo $udata["address"];?></textarea> 
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-6"> 
											<div class="form-group new_blk">
												...
												<input type="hidden" id="hid_mob_fm" name="hid_mob_fm" value="<?php echo $udata["alert_mobile"];?>" class="multvals_fm" />
											</div>
										</div>
										...
										<div class="col-md-6"> 
											<div class="form-group new_blk">
												...
												<input type="hidden" id="hid_mail_fm" name="hid_mail_fm" value="<?php echo $udata["alert_email"];?>" class="multvals_fm" />	
											</div>
										</div>
								...
								<div class="new_part_lst">
									<?php foreach($partnerdata as $pdata){ ?>
									<div class="row"> 
										<div class="col-md-4"> 
											<div class="form-group">
												<label >Partner Name</label>  
												<input type="text" class="form-control" id="pname" name="pname[]" value="<?php echo $pdata["pname"]?>" placeholder="Partner Name"> 
											</div>
										</div>
										...
										<div class="col-md-4"> 
											<div class="form-group">
												<label for="name">Aadhar</label>
												<input type="text" class="form-control allownumericwithoutdecimal" id="paadhar" name="paadhar[]" value="<?php echo $pdata["paadhar"]?>" placeholder="Aadhar">
											</div>
										</div>
										...
										<div class="col-md-4"> 
											<div class="form-group">
												...
												<input type="text" class="form-control allownumericwithoutdecimal" id="pmobile" name="pmobile[]" style="width: calc(100% - 40px);" value="<?php echo $pdata["pmobile"]?>" placeholder="Phone Number">   
											</div>
										</div>										
									</div>
									<?php } ?>
						...
						<div class="col-md-12"> 
							<div class="pad_20 bg_w">
								...
								<?php if(count($cropdata)>0){ $crpcount = count($cropdata);}else{ $crpcount = 0; } ?>
								<div class="hdg_bk">Crop Details (<?php echo $crpcount;?>) <a href="javascript:void(0)" title="" class="fr ad_crp"> + Add Crop </a></div>
								
								<div class="crp_list"> 
									<div class="crp_list_pos">
										<?php foreach($cropdata as $cdata){ ?>
										<div class="crp_dtl_blk">
											<span class="crp_remove"> <img src="http://localhost/ac/assets/images/close_btn.png" alt="" title=""> </span>
											<div class="row">											
												<div class="col-md-6"> 
													<div class="form-group">
														<label for="crop_loc">Crop Location</label>
														<input type="text" class="form-control" id="crop_loc" name="crop_loc[]" value="<?php echo $cdata["crop_loc"];?>" placeholder="Crop Location">   
													</div>
												</div>
												...
												<div class="col-md-6"> 
													<div class="form-group">
														...
														<input type="text" class="form-control" id="crop_type" name="crop_type[]" value="<?php echo $cdata["crop_type"];?>" placeholder="Crop type">
													</div>
												</div>
												...
												<div class="col-md-6"> 
													<div class="form-group">
														...
														<input type="text" class="form-control" id="acres" name="acres[]" value="<?php echo $cdata["crop_acres"];?>" placeholder="Acres" />   
													</div>
												</div>
								...
								<div class="row">
									<div class="col-md-4"> 
										<div class="form-group">
											<label for="name">Feed(%)</label>
											<input type="text" class="form-control" id="feed" name="feed" value="<?php echo $udata["feed_per"];?>" placeholder="Feed" />   
										</div>
									</div>
									...
									<div class="col-md-4"> 
										...
										<input type="text" class="form-control" id="rate_of_int" name="rate_of_int" value="<?php echo $udata["roi"];?>" placeholder="Rate of intrest"> 
										</div>
									</div>
								...
								<!-- <div class="form-group"> <button type="submit" class="btn btn-primary sub_btn" onclick="frmsbmt('fm');checkmobile();">Submit</button></div> -->
							</div>
						</div>
					</div>
					<br/>
				...
				<form action="javascript:void(0)" id="single" name="single" method="post" enctype="multipart/form-data" >				
					<div class="row"> 
							...
							<div class="pad_20">
								<div class="row">
									...
									<div class="col-md-4"> 
										<div class="form-group">
											<label for="name">Name</label>
											<input type="text" class="form-control" id="uname" name="uname" placeholder="Name" value="<?php echo $udata["uname"];?>" />   
										</div>
									</div>
									...
									<div class="col-md-4"> 
										<div class="form-group">
											<label for="name">Guarantor(C/O)</label>
											<input type="text" class="form-control" id="guaran" name="guaran" placeholder="Guarantor(C/O)" value="<?php echo $udata["guarantor"];?>" />   
										</div>
									</div>
									...
									<div class="col-md-4"> 
										<div class="form-group">
											<label for="name">Mobile</label>
											<input type="text" class="form-control allownumericwithoutdecimal" id="mob_numb" name="mob_numb" placeholder="Mobile Number" value="<?php echo $udata["mobile"];?>" onkeyup="checkmobile();" />   
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-6"> 
											<div class="form-group new_blk">
												...
												<input type="hidden" id="hid_mob_fs" name="hid_mob_fs" value="<?php echo $udata["alert_mobile"];?>" class="multvals_fs" />
											</div>
										</div>
										...
										<div class="col-md-6"> 
											<div class="form-group new_blk">
												...
												<input type="hidden" id="hid_mail_fs" name="hid_mail_fs" value="<?php echo $udata["alert_email"];?>" class="multvals_fs" />	
											</div>
										</div>
						...
						<div class="col-md-12"> 
							<div class="pad_20 bg_w">
								<?php if(count($bankdata)>0){ $bcount = count($bankdata);}else{ $bcount = 0; } ?>
								<div class="hdg_bk">Bank Details(<?php echo $bcount;?>) <a href="javascript:void(0)" title="" class="fr ad_bnk"> + Add Bank </a></div>
								...
								<div class="row">
									...
									<div class="col-md-4"> 
										<div class="form-group">
											...
											<input type="text" class="form-control" id="med1" name="med1" value="<?php echo $udata["med1_per"];?>" placeholder="Medicines1">
											<input type="hidden" id="hidfs1" name="hidfs1" value="<?php echo $med1;?>" />
										</div>
									</div>
									...
									<div class="col-md-4"> 
										<div class="form-group">
											...
											<input type="text" class="form-control" id="med2" name="med2" value="<?php echo $udata["med2_per"];?>" placeholder="Medicines2">
											<input type="hidden" id="hidfs2" name="hidfs2" value="<?php echo $med2;?>" />
										</div>
									</div>
									...
									<div class="col-md-4"> 
										<div class="form-group">
											...
											<input type="text" class="form-control" id="med3" name="med3" value="<?php echo $udata["med3_per"];?>" placeholder="Medicines3">
											<input type="hidden" id="hidfs3" name="hidfs3" value="<?php echo $med3;?>" />
										</div>
									</div>
								...
								<div class="doc_up_lode"> 
									<div class="row"> 
										...
										<div class="col-md-4"> 
											<div class="form-group">
												<label> Documents Received Date </label>
												<input placeholder="Documents Received Date" type="date"  id="recdate" name="recdate" value="<?php echo $udata["receive_date"];?>" class="form-control">
											</div>
										</div>
										<div class="col-md-4"> 
											<div class="form-group">
								...
								<div class="row">
									...
									<div class="col-md-4"> 
										<div class="form-group">
											<label> Outstanding Amount </label>
											<input type="text" id="os_amt" name="os_amt" value="<?php echo $udata["os_amt"];?>" placeholder="Outstanding Amount" class="form-control allownumericwithoutdecimal"> 
										</div>
									</div>
								...
								<div class="form-group"> <button class="btn btn-primary sub_btn" onclick="frmsbmt('fs');checkmobile();" >Update</button></div>
		...
		<!-- Farmer Section End -->
			<input type="hidden" id="hid_type" name="hid_type" value="<?php echo $udata["utype"];?>" />
			<input type="hidden" id="hid_cnfsbmt" name="hid_cnfsbmt" value="0" />
			<input type="hidden" id="hid_medval" name="hid_medval" value="" />
			<input type="hidden" id="hid_usercode" name="hid_usercode" value="<?php echo $udata["usercode"];?>" />
			
			<!-- exising images -->
			<input type="hidden" id="hid_aadhar" name="hid_aadhar" value="<?php echo $docs["aadhar"];?>" />
			<input type="hidden" id="hid_pan" name="hid_pan" value="<?php echo $docs["pan"];?>" />
			<input type="hidden" id="hid_gst" name="hid_gst" value="<?php echo $docs["gst"];?>" />
			<input type="hidden" id="hid_cheque" name="hid_cheque" value="<?php echo $docs["cheque"];?>" />
			<input type="hidden" id="hid_promissory" name="hid_promissory" value="<?php echo $docs["promissory"];?>" />
			<input type="hidden" id="hid_gp" name="hid_gp" value="<?php echo $docs["gp"];?>" />
			<input type="hidden" id="hid_stamp" name="hid_stamp" value="<?php echo $docs["stamp"];?>" />
			<input type="hidden" id="hid_partner" name="hid_partner" value="<?php echo $docs["partner"];?>" />
			<!-- End images -->
...
<?php if($udata["utype"]=="fs"){ ?>
	$('#non_frm').hide(); $('#dealer').hide(); $('#former').show(); $('#single').show(); $('#multiple').hide(); 
<?php }else if($udata["utype"]=="fm"){ ?>
	$('#non_frm').hide(); $('#dealer').hide(); $('#former').show(); $('#single').hide(); $('#multiple').show();
<?php }else if($udata["utype"]=="d"){ ?>
	$('#non_frm').hide(); $('#former').hide(); $('#dealer').show(); 
<?php }else if($udata["utype"]=="nf"){ ?>
	$('#non_frm').show(); $('#former').hide(); $('#dealer').hide(); 
<?php } 
if($udata["notify_alert"]==0){ ?>
	$(".aler_lnks").hide();
<?php } ?>
...
{
	var usermob = <?php echo $udata["mobile"]; ?>;
...
function default_multi_mob_mail_remove()
{
	$('.cls_itm').click(function(){
...
$(document).ready(function(){
			  ...
			  '<div class="row dtl_par">', 
				 ...
				 '</div>',
				  ...
				  '<div class="col-md-4">', 
				   '<div class="form-group">',
					   '<label for="name">Phone Number </label>',
					'<input type="text" class="form-control" id="pmobile" name="pmobile[]" placeholder="Phone Number" style="width: calc(100% - 40px); float:left;"> <span class="cl_part"><img src="<?php echo base_url();?>assets/images/close_btn.png" width="17"/></span>',   
				  '</div>',
				  '</div>',
			  '</div>'
			  ];
	...
	$('#cnf_sbmt').click(function(){
		...
		var hid_usercode = $("#hid_usercode").val();		
		formData = new FormData(myForm);
		formData.append('hid_usercode', hid_usercode);
		...
		formData.append('hid_aadhar', $("#hid_aadhar"));
		formData.append('hid_pan', $("#hid_pan"));
		formData.append('hid_gst', $("#hid_gst"));
		formData.append('hid_cheque', $("#hid_cheque"));
		formData.append('hid_promissory', $("#hid_promissory"));
		formData.append('hid_gp', $("#hid_gp"));
		formData.append('hid_stamp', $("#hid_stamp"));
		formData.append('hid_partner', $("#hid_partner"));
...
<div class="side_popup"> 
	<div class="padding_30">
		...
		<?php 
		if($tot_meds != ""){ $med_vals = explode(",",trim($tot_meds,",")); }else{ $med_vals = array();} ?>
		<ul class="al_brands" id="myUL">
			<?php for($i=0;$i<20;$i++){ ?>
			<li id="<?php echo $i+1;?>" rel="Brand <?php echo $i+1;?>"> 
				<div class="form-check" >
					<?php if(count($med_vals)>0){ 
						if (in_array($i+1, $med_vals)){ $bcheck = "checked"; }else{	$bcheck = "";} ?>
						
						<input type="checkbox" class="form-check-input" id="brand<?php echo $i+1;?>" id="brand" name="brand[]" value="<?php echo $i+1;?>" <?php echo $bcheck;?> onchange="barndcheck('<?php echo $i+1;?>');" />
