<table style="border: 1px solid #ccc; font-family: arial; font-size: 9px; text-align: left;" width="100%" border="0" cellpadding="5" cellspacing="0"> 	
    <tr>
        <td colspan="3" style="background: #ddd;"><h1 style="color: #373c4f;font-weight: bold;;font-size: 12px; margin: 0px; padding: 0px;"> <?php echo $trader["full_name"];?> / <small><?php echo $trader["firm_name"];?> 	</small> / <small> #<?php echo $trader["trader_code"];?> </small> </h1> </td>
        </tr>
        <tr> 
        ...
        <tr> 
            ...
            <td style="padding-top: 10px; padding-bottom: 10px; padding-left: 15px; padding-left: 15px; text-align: right;"><b><?php echo $trader["balance"];?></b> </td>
        </tr>
        <tr>  
