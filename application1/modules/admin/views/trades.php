			...
			<div class="trd_cr">
				...
				<div class="trd_c_row frm_prc">
					...
					<div class="cre_inp">
						...
						<input type="text" maxlength="10" class="form-control noalpha mykey" placeholder="" name="exp_farmer_price_val" id="exp_farmer_price_val" onchange="amount_with_commas();">
					...
					<div class="">
						...
						<input type="text" maxlength="10" class="form-control noalpha mykey" placeholder="" name="exp_company_price_val" id="exp_company_price_val" onchange="amount_with_commasval();">
				...
				<a href="" title="" class="ad_note" data-toggle="modal"> Note </a>
					<div class="note_entr">
						<div class="form-group note_area">
							<textarea placeholder="Note" id="note_edit" name="note_edit" class="mykey" disabled></textarea>
						</div>
					</div>
			</li>
		</ul>
...
function calculateTotal() {
	...
	$("[id^='tcprice_']").each(function() {
		...
		$('#tcamount_' + id).val(number_format(total,4));
		$('#tcamountval_' + id).val(roundTo(total,4));
	...
	$('#cweight').html(roundTo(cweightTot,4));
	var cmt = number_format(camountTot,2);
	$('#camount').html(cmt);
	...
	$('#cweightval').val(roundTo(cweightTot,4));
	$('#camountval').val(roundTo(camountTot,2));
}
...
function calculateTotal1() {
	...
	$("[id^='tfprice_']").each(function() {
		...
		$('#tfamount_' + id).val(number_format(total,4));
		$('#tfamountval_' + id).val(roundTo(total,4));
	...
	$('#gtotal').html(number_format(GrandTot,2));
	$('#fweight').html(roundTo(fweightTot,4));
	var cmt = number_format(famountTot,2);
	$('#famount').html(cmt);


	$('#gtotalval').val(roundTo(grandTotal,2));
	$('#fweightval').val(roundTo(fweightTot,4));
	$('#famountval').val(roundTo(famountTot,2));
}
