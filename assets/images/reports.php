...
.sts_fil_blk {top: 38px;}
	...
	.al_r_tbl td, .al_r_tbl th, .cash_tbl td, .cash_tbl th {color: #58666e; background: none!important; font-size: 13px; padding:0px 20px!important; height: 40px;}
	...
	<div class="anl_btn"> 
			...
			<div class="tbls_blk"> 
							...
							<thead>
								<tr> 
									<th colspan="4" style="height: 62px;"> 
										<h2 class="create_hdg" style="padding-top: 20px; padding-bottom: 10px;"> Cash Book </h2>
									 </th>									
								</tr>
							</thead>
							<tbody>
					...
					<div class="sts_fil_blk rad_btns"> 
									...
									<td class="txt_rt" style="padding-right: 40px!important;"> Amount </td>
								</tr>
								<tr> 
									<td> 20-May-2020 </td>
									<td> Loan - 0566 </td>
