        ...
        res12 = JSON.parse(response12);                         
            if(res12.length>0)
            {
                $.each(res12, function(index, prod) {
                  ...
                  htmlr += '<tr><td class="brnd_ane"> <a href="javascript:void(0)"> '+prod.product_name+'</a></td><td class="pp_amnt txt_rt"> '+prod.totprice+' </td><td class="pp_dis"> <input type="text" name="pro_discount[]" id="pro_discount'+ind+brandid+category+'" onkeypress="return validateFloatKeyPress(this,event);" value="'+pdisc+'"><input type="hidden" name="categoryid[]" id="categoryid'+ind+brandid+category+'" value="'+category+'"><input type="hidden" name="brandid[]" id="brandid'+ind+brandid+category+'" value="'+brandid+'"><input type="hidden" name="pbranddiscountval[]" id="pbranddiscountval'+ind+brandid+category+'" value="'+pdiss+'"><input type="hidden" name="prosids[]" id="prosids'+ind+brandid+category+'" value="'+prod.sids+'" ><input type="hidden" name="prodid[]" id="prodid'+ind+brandid+category+'" value="'+prod.product_id+'"><input type="hidden" id="pro_t'+ind+brandid+category+'" value="0" /><input type="hidden" value="'+prod.proamount+'" name="pro_totamount[]" id="pro_totamount'+ind+brandid+category+'" ><input type="hidden" value="'+prod.totprice+'" name="pro_totvalact[]" id="pro_totvalact'+ind+brandid+category+'" ></td><td class="pp_ttl txt_rt" id="pro_total'+ind+brandid+category+'"> '+currency_format(prod.totprice,2)+' </td></tr>';
    ...
    $("[id^='pro_discount']").each(function() {
        ...
        id = id.replace("pro_discount", '');
            ...
            if(prodisc!='' && prodisc!=undefined && prodisc!=null)
            {
           	...
           	$.ajax({
		      url: url+"api/users/purchaseamountval",
		      ...
		      success : function(response1){
		         ...
		         if(parseFloat(ptot1)<parseFloat(response1))
		         {
             ...
             else
             {
                ...
                if(ii==0 )
                {
                  ...
                  $('#brandtotamtvalact' + id).val(tot1);
                  $('#brandtotamtval' + id).prop('disabled',true);
                }
             }
		      }
		    });
