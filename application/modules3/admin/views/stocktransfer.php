...
<div id="create_module" role="dialog" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<a href="javascript:void(0);" id="add_row" name="add_row" class="pull-right">Add Row</a><br/>
			...
			<div class="transport_blk">
				<table class="ord_lst">
					<tbody>
						...
						<tr class="dest_trans_block"> 
							<td class="text_rt"> Transport Charges (Destination)(₹)</td>
							<td class="trns_val"> <input type="text" id="desti_trans_chrg" name="desti_trans_chrg"  class="text_rt noalpha table_input" value="0" onkeyup="amount_with_commas('add',this.id);" />
							<input type="hidden" id="hid_desti_trans_chrg" name="hid_desti_trans_chrg"  class="text_rt allownumericwithdecimal" value="0" /></td>
						</tr>
						<tr class="unload_block"> 
							<td class="text_rt"> Unloading Charges (₹)</td>
							<td class="trns_val"> <input type="text" id="unload_chrg" name="unload_chrg" class="text_rt noalpha table_input" value="0" onkeyup="amount_with_commas('add',this.id);" /><input type="hidden" id="hid_unload_chrg" name="hid_unload_chrg" class="text_rt allownumericwithdecimal" value="0" />  </td>
						</tr>
			...
			<div class="pop_footer">
				...
				<button type="button" class="btn btn-success btn-sm rc_btn fr" style="margin-top: 9px;">Receive</button>			
				<input type="submit" class="btn btn-primary btn-sm fr sb_btn" style="margin-right: 10px;" value="Create Transfer" />
				...
				<input type="hidden" id="hid_srcid" name="hid_srcid" />   
				<input type="hidden" id="hid_dstid" name="hid_dstid" />   
				<input type="hidden" id="src_dst" name="src_dst" />   
				<input type="hidden" id="role" name="role" />   
				<input type="hidden" id="sa_action" name="sa_action" />   
...
<div id="popover-content_view" style="display: none">
	<div class="custom-popover">
		<ul class="list-group">
			<li class="list-group-item edt green_txt">View</li>
		</ul>
	</div>
</div>

<div class="modal" id="delete_stock">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-body" style="text-align:center;">
				<h1> Are You Sure ! </h1>
				<p> You want Remove This Record ? </p>
			</div>
