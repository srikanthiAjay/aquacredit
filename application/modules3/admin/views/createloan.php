			...
			<div class="col-md-4">
				<div class="card_view actvty">    
					...
					<ul class="lns_sub_blk"> 
						<li class="anlat_bb" data-toggle="popover" data-placement="left" tabindex="0" data-trigger="focus" aria-hidden="true" onclick="typeindividual('a_amt');"> 
						...
						<li class="anlat_bb" data-toggle="popover" data-placement="left" tabindex="0" data-trigger="focus" aria-hidden="true" onclick="typeindividual('p_amt');"> 
