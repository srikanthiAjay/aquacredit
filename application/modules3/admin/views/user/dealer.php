...
<div class="right_blk">
	...
	<div class="padding_30">
		<ul class="usrs_blk"> 
			...
			<li class="far_act deal_sub_del"  id="dl_icn"><a href="<?php echo base_url();?>admin/users/createdealer"> <img src="<?php echo base_url();?>assets/images/dealer.png"><span>Dealer / Sub-Dealer</span></a></li>
