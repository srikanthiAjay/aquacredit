...
function get_traders(type = null)
{
	...
	$.ajax({
		...
		success : function(response){
			...
			if(res.data.length > 0)
			{
				opt += '<div class="form-check chek_bx"><input class="form-check-input" type="checkbox" name="" value="" id="trdd0"><label class="form-check-label" for="trdd0" id="trdd_text0"><strong>Select All</stron></label></div>';
...
function get_users(type = null)
{
	...
	$.ajax({
		...
		success : function(response){
			...
			if(res.data.length > 0)
			{
				opt += '<div class="form-check chek_bx"><input class="form-check-input" type="checkbox" name="" value="" id="usr0"><label class="form-check-label" for="usr0" id="usr_text0"><strong>Select All</stron></label></div>';
	...
	$("#tradefrm").submit(function(e) {
		...
		if(trade_type == "guest")
		{
			...
			if(mobile == ""){ err = 1; err_msg = "Please enter mobile!"; tagid = "#mobile";
				return form_validation(err,err_msg,tagid);}
			if(mobile.length != "10"){ err = 1; err_msg = "Enter valid mobile!"; tagid = "#mobile";
				return form_validation(err,err_msg,tagid);}
		}
		if(trade_type == "credit")
		{
