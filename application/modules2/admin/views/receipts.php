...
<style>.res_tbl table{ min-width: 0px !important;} </style>
<div class="right_blk"> 
...
<div id="apr_loan" role="dialog" class="modal fade"> 
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="pp_clss" data-dismiss="modal"> <i class="fa fa-times" aria-hidden="true"></i> </div>
			<h1> Receipts <!-- <i class="fa fa-edit edt_bl_lnk" aria-hidden="true"></i> --></h1>
			<form id="receiptfrm_edit" name="receiptfrm_edit" action="javascript:void(0);" method="post">
				...
				<div class="app_pop_tbl disb_sel"> 
					...
					<div class="row_blk"> 
						<div class="row_left adm_bn_ls" id="bank_block_edit" > 
							<div class="check_wt_serc val_seld">								
					...
					<div class="pop_footer">
						<div class="ad_nt note_blk sh_nt"> 
							<a href="#" title="" class="ad_note" data-toggle="modal"> Note </a> 
							<div class="note_entr">
								<div class="form-group note_area"> 
									<textarea id="rece_note_edit" name="rece_note_edit" disabled ></textarea>
								</div>
							</div>
						</div>
...
<div id="popover-ana_usr" style="display: none">
	<div class="custom-popover">
		<ul class="list-group">
			<li class="list-group-item">Farmers <br/>
			  <span class="blue_text f_amt"> ₹0 </span></li>
			<li class="list-group-item">Dealers <br/>
			  <span class="blue_text dl_amt"> ₹0 </span></li>
			<li class="list-group-item">Non-Farmers<br/>
			  <span class="blue_text nf_amt"> ₹0 </span></li>
			<li class="list-group-item">Guest Sales <br/>
