        ...
        <div class="modal-content content" id="modal_content">
                    ...
                    <ul class="assign_type">
                        ...
                        <li class="bor_lf_none pur_pr">
                            <div class="top_in_op crop_top">
                                <p>Purchase Amount</p>
                                <h1><input type="text" value="" id="tot_pcamt" name="tot_pcamt"/></h1>
                            </div>
                        </li>
                    </ul>
                        ...
                        <ul class="trans_inf">
                            ...
                            <li class="admin_bank_li bktr">
                                <div class="check_wt_serc admin_co_acc" id="adminacc_admin">
                                    ...
                                    <ul class="check_list" id="banklist_admin">
                                        <!-- <li>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="trader" id="bnk1" value="Bank 1" onclick="Purchase.selectAccount('admin','banklist','bnk1');"/>
                                                <label class="form-check-label" for="bnk1">
                                                    ...
                                                    <div class="bank_mny">
                                                        ...
                                                        <div class="accont_numb" id="admin_bnk1">xxxxxxxxx01792</div>
                                                    </div>
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="trader" id="bnk2" value=" Bank 2" onclick="Purchase.selectAccount('admin','banklist','bnk2');" />
                                                <label class="form-check-label" for="bnk2">
                                                    ...
                                                    <div class="bank_mny">
                                                        <div class="bank_bal">₹ 10,000</div>
                                                        <div class="accont_numb" id="admin_bnk2">xxxxxxxxx01122</div>
                                                    </div>
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="bnk3">
                                                    ...
                                                    <div class="bank_mny">
                                                        <div class="bank_bal">₹ 10,000</div>
                                                        <div class="accont_numb">xxxxxxxxx01233</div>
                                                    </div>
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="bnk4">
                                                    ...
                                                    <div class="bank_mny">
                                                        <div class="bank_bal">₹ 10,000</div>
                                                        <div class="accont_numb">xxxxxxxxx01555</div>
                                                    </div>
                                                </label>
                                            </div> -->
                                        </li>
                            ...
                            <li class="us_bn_ls bktr">
                                <div class="check_wt_serc admin_co_acc" id="adminacc_co">
                                    ...
                                    <ul class="check_list" id="banklist_co">
                                        <!-- <li>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" id="bnk5" name="coacc"  value="Bank 1" />
                                                <label class="form-check-label" for="bnk5">
                                                    <div class="bank_logo" onclick="Purchase.selectAccount('co','banklist','bnk5');"><img src="http://3.7.44.132/aquacredit/assets/images/sib_icn.png" alt="" title="" /></div>
                                                    <div class="bank_mny">
                                                        <div class="bank_bal">₹ 10,000</div>
                                                        <div class="accont_numb" id="co_bnk5">xxxxxxxxx01010</div>
                                                    </div>
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" id="bnk6" name="coacc"  value=" Bank 2" onclick="Purchase.selectAccount('co','banklist','bnk6');"/>
                                                <label class="form-check-label" for="bnk6">
                                                    <div class="bank_logo"><img src="http://3.7.44.132/aquacredit/assets/images/hdfc_icn.png" alt="" title="" /></div>
                                                    <div class="bank_mny">
                                                        <div class="bank_bal">₹ 10,000</div>
                                                        <div class="accont_numb" id="co_bnk6">xxxxxxxxx022225</div>
                                                    </div>
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" id="bnk7" name="coacc"  value="Bank 3" />
                                                <label class="form-check-label" for="bnk3">
                                                    <div class="bank_logo"><img src="http://3.7.44.132/aquacredit/assets/images/icici_icn.png" alt="" title="" /></div>
                                                    <div class="bank_mny">
                                                        <div class="bank_bal">₹ 10,000</div>
                                                        <div class="accont_numb">xxxxxxxxx016165</div>
                                                    </div>
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" id="bnk8" name="coacc"  value="Bank 4" />
                                                <label class="form-check-label" for="bnk4">
                                                    <div class="bank_logo"><img src="http://3.7.44.132/aquacredit/assets/images/hdfc_icn.png" alt="" title="" /></div>
                                                    <div class="bank_mny">
                                                        <div class="bank_bal">₹ 10,000</div>
                                                        <div class="accont_numb">xxxxxxxxx09999</div>
                                                    </div>
                                                </label>
                                            </div> -->
                                        </li>
            ...
            <div class="comp_blk">
                <div class="ord_comp_bl">
                    ...
                    <div class="tab-content" id="branchplist">
                    </div>
                </div>
                <!-- <div class="po_ftr">
