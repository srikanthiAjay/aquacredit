									...
									<div class="row">
										...
										<div class="col-md-6"> 
											<div class="form-group">
												...
												<input type="text" class="form-control input_disable" id="transaction_balance_<?php echo $cc_id;?>" name="transaction_balance[]" placeholder="Open Balance
												" onkeypress="return allowNumerORDecimal(event,this)" value="<?php echo $crops[$c]['transaction_balance'];?>">
												<label id="transaction_balance_<?php echo $cc_id;?>-error" class="error" for="transaction_balance_<?php echo $cc_id;?>"></label>  
											</div>
										</div>
					...
					<div class="row">
						...
						<div class="col-md-4"> 
							<div class="form-group">
								...
								<input type="text" placeholder="Credit" id="credit_limit" name="credit_limit" class="form-control input_disable allownumericwithoutdecimal"  value="<?php echo $user['credit_limit'];?>"> 
							</div>
						</div>
