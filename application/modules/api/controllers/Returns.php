		...
		if(count($returns)>0)
		{
			foreach($returns as $r) {
				...
				$data[] = array(					
					...
					$branch_name,
					'₹'.$return_amt,
					'<i class="fa fa-ellipsis-v act_icn" data-toggle="popover" data-placement="left" tabindex="0" data-trigger="focus" aria-hidden="true" data-content="" onclick="edit_returns('.$rtn_id.','.$branch_id.','.$crop.');"></i>'
				);
			}
		}
