...
<div class="right_blk">
	...
	<div class="sle_cr_r"> 
		...
		<ul class="create_ul"> 
					...
					<li class="create_li">
					<div class="cre_inp">
					  <div class="sm_blk"> <span style="color: red">*</span> Search User </div>
      ...
      res= JSON.parse(response);        
        ...
        if(res.data.length > 0)
        {
            $.each(res.data, function(index, crop) {
				opt += '<div class="form-check"><input class="form-check-input" onclick="hidecolor('+crop.branch_id+');" type="radio" name="branchval" id="branch'+index+'" value="'+crop.branch_id+'" /><label class="form-check-label" for="branch'+index+'">'+crop.branch_name+'</label></div>';
          });
        }
      ...
      if(user_id != "")
      {
        ...
        if(res.data.length > 0)
        {
          ...
          $.each(res.data, function(index, crop) {
            ...
            opt += '<div class="form-check"><input class="form-check-input" onclick="hidecolor('+crop.cd_id+');" type="radio" name="crop_opt'+aeval+'" id="crp'+index+aeval+'" value="'+crop.cd_id+'" '+sel+' /><label class="form-check-label" for="crp'+index+aeval+'">'+crop.crop_location+'</label></div>';
          });
        }
      }else{
...
$(document).ready(function(){
	...
	for(var ii=0;ii<=rr;ii++)
	{
	    ...
	    rowNum ++;
	    htmlRows = '<tr id="rowNums'+rowNum+'" ><td><input type="hidden" placeholder="Product Name" name="proid[]" id="proid'+rowNum+'" value="0" ><input class="mykey" type="text" placeholder="Product Name" autocomplete="off" name="proname[]" id="proname'+rowNum+'" ><input class="mykey" type="hidden" name="purchase_amt[]" id="purchase_amt'+rowNum+'" > </td><td class="qty txt_cnt"> <input type="text" class="mykey" placeholder="0" onkeypress="return onlyNumberKey(event)" name="proqty[]" id="proqty'+rowNum+'"></td><td class="mrp txt_rt"> <input type="text" class="mykey" readonly placeholder="0" name="promrp[]" id="promrp'+rowNum+'"><input type="hidden" placeholder="0" name="promrpval[]" id="promrpval'+rowNum+'"> </td><td class="disc txt_rt"> <input type="text" class="mykey disckey noalpha" placeholder="0" name="prodisc[]" id="prodisc'+rowNum+'" maxlength="4" onkeypress="return validateFloatKeyPress(this,event);" autocomplete="off" '+sel+' > </td><td class="ttl_prc txt_rt"> <input type="text" placeholder="0" readonly name="protot[]" id="protot'+rowNum+'"><input type="hidden" placeholder="0" name="prototval[]" id="prototval'+rowNum+'" > </td><td class="dele_th_td"><i class="fa fa-trash" onclick="removerow('+rowNum+')" style="color:red" ></i></td></tr>';
...
function calculateTotal() {
    ...
    $("[id^='proqty']").each(function() {
       ...
       //alert(prodisc);
		...
		if(tot1!=0)
        {
	        if ((parseFloat(tot1) < parseFloat(purchaseamt)) && prodisc!='') {
	        	
	            alert('Discount should be lessthan purchase amount, purchase amount is ' + purchaseamt);

	            $('#prodisc' + id).val('');

	            $('#protot' + id).val(promrpval);
	        	$('#prototval' + id).val(promrpval);
...
function removerow(id)
{
	...
	else if(rr==0)
	{
		...
		htmlRows = '<tr id="rowNums0" ><td><input type="hidden" placeholder="Product Name" name="proid[]" id="proid0" value="0"><input class="mykey" type="text" placeholder="Product Name" name="proname[]" id="proname0" autocomplete="off" > <input class="mykey" type="hidden" name="purchase_amt[]" id="purchase_amt0" ></td><td class="qty txt_cnt"> <input type="text" class="mykey" placeholder="0" onkeypress="return onlyNumberKey(event)" name="proqty[]" id="proqty0"></td><td class="mrp txt_rt"> <input type="text" class="mykey" readonly placeholder="0" name="promrp[]" id="promrp0"><input type="hidden" placeholder="0" name="promrpval[]" id="promrpval0"> </td><td class="disc txt_rt"> <input type="text" class="mykey disckey noalpha" placeholder="0" name="prodisc[]" onkeypress="return validateFloatKeyPress(this,event);" id="prodisc0" maxlength="4" autocomplete="off"> </td><td class="ttl_prc txt_rt"> <input type="text" placeholder="0" readonly name="protot[]" id="protot0"><input type="hidden" placeholder="0" name="prototval[]" id="prototval0"><input type="hidden" class="form-control noalpha mykey" placeholder="" readonly name="hid_acivity_id[]" id="hid_acivity_id_0" value="0"></td><td class="dele_th_td"> <i class="fa fa-trash" onclick="removerow(0,0)" style="color:red"></i> </td></tr>';
...
function addmorerows()
{
	...
	else
	{
	    ...
	    htmlRows = '<tr id="rowNums'+rowNum+'" ><td><input type="hidden" placeholder="Product Name" name="proid[]" id="proid'+rowNum+'" value="0" ><input class="mykey" type="text" placeholder="Product Name" autocomplete="off" name="proname[]" id="proname'+rowNum+'" > </td><td class="qty txt_cnt"><input class="mykey" type="hidden" name="purchase_amt[]" id="purchase_amt'+rowNum+'" > </td><td class="qty txt_cnt"> <input type="text" class="mykey" placeholder="0" onkeypress="return onlyNumberKey(event)" name="proqty[]" id="proqty'+rowNum+'"></td><td class="mrp txt_rt"> <input type="text" class="mykey" readonly placeholder="0" name="promrp[]" id="promrp'+rowNum+'"><input type="hidden" placeholder="0" name="promrpval[]" id="promrpval'+rowNum+'"> </td><td class="disc txt_rt"> <input type="text" class="mykey disckey noalpha" placeholder="0" name="prodisc[]" id="prodisc'+rowNum+'" onkeypress="return validateFloatKeyPress(this,event);" '+sel+' autocomplete="off" maxlength="4" > </td><td class="ttl_prc txt_rt"> <input type="text" placeholder="0" readonly name="protot[]" id="protot'+rowNum+'"><input type="hidden" placeholder="0" name="prototval[]" id="prototval'+rowNum+'" > </td><td class="dele_th_td"><i class="fa fa-trash" onclick="removerow('+rowNum+')" style="color:red" ></i></td></tr>';
