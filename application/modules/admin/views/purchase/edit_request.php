<div id="edit_module" role="dialog" class="modal fade">
    <div class="modal-dialog purchase_modal">
        ...
        <div class="modal-content" id="mcontent_id">
            ...
            <h2 class="create_hdg" style="margin-bottom: 15px;"><span id="req_status_id">Update Request</span> <span id="emsg"></span></h2>
            <ul class="trans_inf ll_inp">
                ...
                <li>
                    <div class="check_wt_serc" id="bds_list_id">
            ...
            <div class="fl_over" id="uploading">
                    ...
                    <table>
                        <tbody>
                            <tr class="disc_blk">
                                ...
                                <td colspan="2" class="green_txt"><input type="text" id="unloading_charges" name="unloading_charges" class="text_rt" value="0" /></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <div class="avail_bal" id="trs_chr">
                    <table>
                        <tbody>
                            <tr class="disc_blk">
                                ...
                                <td class="">
                                    <input type="text" id="transport_charges" name="transport_charges" class="text_rt" value="0" />
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    <div class="checkbox adm_ant" id="bwallet_remain" style="display: none;">
                        <div class="row">
                            <div class="col-md-7">
                                <label><input type="checkbox" id="branch_pay_by" name="pay_by" value="branch" checked="checked" disabled/>Use Cash Balance</label>
                                <p class="bal_amn_cash">Remaining Balance: <span id="bwallet_bal"></span></p>
                            </div>
                            <div class="col-md-5">
                                <div class="top_in_op text_rt crop_top">
                                    <p class="text_rt">Don't have a sufficient balance</p>
                                    <!-- <h1 class="text_rt" id="bwallet_bal"></h1> -->
                                    <p class="text_rt"><input type="checkbox" id="admin_pay_by" name="pay_by" value="admin"/>Admin pay</p>
                                    <input type="hidden" id="pay_by" value="branch">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="po_ftr">
                ...
                <button type="button" class="btn fr sb_btn btn-primary" onclick="Purchase.updatePayment();" id="paymentbtn" style="display:none;">Confirm <span id="epayloader"></span></button>
                <span id="updmsg"></span>
            </div>
