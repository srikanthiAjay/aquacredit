...
<div id="former_div">
 ...
 <form id="dealerform" name="dealerform" method="post" enctype="multipart/form-data" >	
	<div class="pad_20">
		<div class="hdg_bk"> <span id="act_text">View</span> Dealer <span id="success_msg" style="color:green;"></span>
		...
		<div class="row"> 
			...
			<div class="col-md-12"> 
				<div class="pad_20 bg_w" id="bank_block">
					...
					<div class="row">
						...
						<div class="col-md-4"> 
							<div class="form-group">
								...
								<input type="text" placeholder="Open Balance" id="open_balance" name="open_balance" class="form-control input_disable allownumericwithoutdecimal" value="<?php echo $user['open_balance'];?>"> 
							</div>
						</div>
					...
					<div class="form-group hide_action_btn"> <button type="submit" class="btn btn-primary sub_btn" onclick="return validateDealer();" id="sub_btn">Submit <span id="loader"></span></button>&nbsp;&nbsp;<span id="sub_btn_msg"></span></div>
				</div>
			</div>
		</div>
		<br/>
