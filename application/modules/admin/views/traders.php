				...
				<div class="trd_cr"> 
					...
					<div class="type_trd rad_btns">
						<label class="radio-inline radio_blk checkd">
							<input type="radio" value="Agent" name="trader_type" id="trader_type_agent">Agent
						</label>
						<label class="radio-inline radio_blk">
							<input type="radio" value="Exporter" name="trader_type" id="trader_type_exporter">Exporter
						</label>
					</div>
...
<div id="popover-content1" style="display: none">
	<div class="custom-popover">
		<input type="hidden" id="trader_edit_id">
		<ul class="list-group">
