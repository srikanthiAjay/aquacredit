					...
					<div class="row">
						...
						<div class="col-md-3"> 
							...
							<span class="border-lable-flt">								
								<input type="text" class="form-control" id="brand_name" name="brand_name" placeholder="Company Name" required autofocus />
						...
						<div class="col-md-3"> 
							<div class="form-group">
								<span class="border-lable-flt">									
									<input type="text" class="form-control" id="contact_person" name="contact_person" placeholder="Contact Person Name" required autofocus />
						...
						<div class="col-md-3"> 
							<div class="form-group">
								<span class="border-lable-flt">
									<input type="text" class="form-control" id="p_mobile" name="p_mobile" placeholder="Mobile Number" required autofocus />
						...
						<div class="col-md-3"> 
							<div class="form-group">
								<span class="border-lable-flt">									
									<input type="email" class="form-control" id="p_email" name="p_email" placeholder="Email" required autofocus />
						...
						<div class="col-md-3"> 
							<div class="form-group">
								<span class="border-lable-flt">								
									<input type="text" class="form-control" id="p_loc" name="p_loc" placeholder="Location" required autofocus />
						...
						<div class="row">
							<div class="col-md-3">
								<div class="form-group">
									...
									<select id="cati" name="cati[]" multiple="multiple" required >
									</select>
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<select id="sub_cati" name="sub_cati[]" multiple="multiple" required >
									</select>
							...
							<div class="col-md-3 med_div"> 
									...
									<select name="med" class="form-control custom-select" required > 
					...
					<div class="cat_blk_nn">
						...
						<div class="row">
							<div class="col-md-3"> 
								<div class="form-group">
									<span class="border-lable-flt">										
										<input type="text" class="form-control" id="holder_name" name="holder_name" placeholder="Account Holder Name" required autofocus />
										<label class="control-label required" for="holder_name"> Account Holder Name </label>
									</span>
								</div>
							</div>
							<div class="col-md-3"> 
								<div class="form-group">
									<span class="border-lable-flt">									
										<input type="text" class="form-control allownumericwithoutdecimal" id="acc_no" name="acc_no" placeholder="Account Number" required autofocus />
										<label class="control-label required" for="acc_no" > Account Number </label>
									</span>
								</div>
							</div>
							<div class="col-md-3"> 
								<div class="form-group">
									<span class="border-lable-flt">	
										<input type="text" class="form-control" id="bank_name" name="bank_name" placeholder="Bank Name" required autofocus />
										<label class="control-label required" for="bank_name"> Bank Name </label>
									</span>
								</div>
							</div>
							<div class="col-md-3"> 
								<div class="form-group">
									<span class="border-lable-flt">										
										<input type="text" class="form-control alphanumeric" id="ifsc_code" name="ifsc_code" placeholder="IFSC Code" required autofocus />
										<label class="control-label required" for="ifsc_code" > IFSC Code </label>
									</span>
								</div>
							</div>
							<div class="col-md-3"> 
								<div class="form-group">
									<span class="border-lable-flt">										
										<input type="text" class="form-control" id="branch_name" name="branch_name" placeholder="Branch Name" required autofocus />
										<label class="control-label required" for="branch_name" > Branch Name </label>
									</span>
								</div>
							</div>
						</div>
					...
					<div class="cat_blk_nn">
						...
						<div class="row">
							<div class="col-md-3"> 
								<div class="form-group">
									<span class="border-lable-flt">
										<input type="text" class="form-control mykey" id="tbal_commas" name="tbal_commas"  value="0" onkeyup = "amount_with_commas('add');" onblur = "amount_with_commas('add');"  placeholder="Opening Balance" />
