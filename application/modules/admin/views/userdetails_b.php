	...
	<div class="tab_cnt_blk">
		...
		<table border="0" cellpadding="0" cellspacing="0" id="usr_lst_tbl1">
			...
			<tr>
				...
				<td class="txt_red txt_rt out_td"> -10,000 <span class="arr_blk"> <img src="http://3.7.44.132/aquacredit/assets/images/rd_c_ar.png" class="mCS_img_loaded"> </span> </td>
			</tr>
			<tr>
				<td> </td>
		...
		<tbody>
					...
					<div id="table_footer"  style="width:100%;padding: 10px 0;">
						...
						<tr>
							<td class="opic_non date"> &nbsp;   </td>
							<td class="txt_rt"> Total </td>
							<td class="txt_rt in_td tr_amount"><span id="total_amaount"></span>  </td>
...
<script src="<?php echo base_url(); ?>assets/js/userdetails1.js"></script>
