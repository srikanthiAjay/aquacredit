...
<body>
	<table style="border: 1px solid #ccc; font-family: arial; font-size: 12px; text-align: left;" width="595" border="0" cellpadding="0" cellspacing="0"> 	
		<tr>
<td colspan="3" style="background: #ddd; padding: 10px 10px 0px 20px;"> <h1 style="color: #373c4f;font-weight: bold;;font-size: 16px; margin: 0px;">  <?php echo $trader["full_name"];?> <?php if(!empty($trader["firm_name"])) {?>/ <small><?php echo $trader["firm_name"];?> <?php }?>	</small> / <small> TDR<?php echo $trader["td_id"];?> </small> </h1> </td>
		 </tr>
			<tr> 
