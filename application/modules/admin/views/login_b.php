...
<link href="<?php echo base_url();?>assets/css/login.css" type="text/css" rel="stylesheet">
		 <div class="lgoin_main"> 
			<div class="login_blk"> 
				...
				<!-- <div class="form-group"><p id="image_captcha"><?php echo $captchaImg; ?><a href="javascript:void(0);" class="captcha-refresh" >
                    <img src="<?php echo base_url().'assets/images/refresh.png'; ?>" width="30" /></a> </p>
                    <div class="form-group">
