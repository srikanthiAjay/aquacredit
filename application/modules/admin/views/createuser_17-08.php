...
<div class="right_blk"> 
	...
	<span class="back_btn">
		<!-- <a href="<?php echo base_url();?>admin/users/" title=""><img src="<?php echo base_url();?>assets/images/back.png" alt="" title=""> </a> --></span>
	...
	<div class="padding_30">
		<ul class="usrs_blk"> 
			<li class="far_act" id="far_icn"> <img src="<?php echo base_url();?>assets/images/farmer.png"><span>Farmer</span> </li>
			<li id="dl_icn"> <img src="<?php echo base_url();?>assets/images/dealer.png"><span>Dealer / Sub-Dealer</span></li>
			<li id="non_va_icn"> <img src="<?php echo base_url();?>assets/images/non_farmer.png"><span>Non-Farmer</span></li>
							...
							<div class="row">
								...
								<div class="col-md-4"> 
									<div class="form-group">
										...
										<input type="text" class="form-control allownumericwithoutdecimal" id="mob_numb" name="mob_numb" placeholder="Mobile Number" value="" onkeyup="checkmobile();">   
									</div>
								</div>
					...
					<div class="row"> 
						...
						<div class="col-md-12"> 
							<div class="pad_20 bg_w">
								...
								<div class="form-group"> <button class="btn btn-primary sub_btn" onclick="frmsbmt('fs');checkmobile();" >Submit</button></div>
...
function checkmobile()
{
	...
	if(mobval !=""){ 
		$.ajax({		
			url: url+"admin/api/checkmobile_exists",
