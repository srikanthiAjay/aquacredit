...
<div class="side_menu"> 
	...
	<div class="menu_list">		
		<ul> 
			...
			<li> 
				<a href="<?php echo base_url();?>admin/brands" title="" <?php if($page == "brands") echo "class='act_menu'";?>> <i> <img src="<?php echo base_url();?>assets/images/brand.png"> </i> <span> Brands </span> </a>
			</li>
			<li> 
