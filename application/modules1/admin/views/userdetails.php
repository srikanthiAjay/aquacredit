                ...
                <div class="analtic_blk"> 
                  ...
                  <ul class="ttl_blk_ul"> 
                    <li class="prd_typ"> 
                      ...
                      <span class="li_amnt_an">   <b id="grandtotal_amount">₹0</b>    </span>
                    </li>
                    <li class="pad_l_none"> 
                      <span class="anl_sml_txt">Total Discount</span> 
                      <span class="li_amnt_an blue_txt">   <b id="granddiscount_amount">₹0</b>   </span>
                    </li>
                  </ul>
                </div>
            </div>
...
function getlloandata()
{
  ...
  var user_id = "<?php echo $user["user_id"];?>";
      ...
      if(res1.length>0)
      {
          ...
          sumrecord =  '<ul ><li class="prd_typ"><span class="anl_sml_txt">'+trades.categoryname+'</span><span class="li_amnt_an">  ₹'+addCommas(trades.totalamount)+'</span></li><li class="discount_li"><span class="anl_sml_txt">Discount</span><span class="li_amnt_an">- ₹0</span></li><li class="eql_tbl"> = </li><li><span class="anl_sml_txt">Total</span><span class="li_amnt_an blue_txt"> <b>₹'+addCommas(trades.totalamount)+'</b> </span></li></ul>';
          		...
          		for (var ii=0;ii<=arr.length;ii++)
      				{
      					...
      					{
      						  htmlRows += '<tr><td class="brnd_ane" data-toggle="collapse" data-target="#prds_tbl'+index+'" aria-expanded="false" aria-controls="prds_tbl'+index+'"><a href="#" onclick="return getdivpro('+user_id+','+crpid+','+trades.category+','+arrb[ii]+','+index+');">'+arr[ii]+'</a></td><td class="pp_amnt txt_rt">'+ttt[ii]+'</td><td class="pp_dis"><input type="text" id="discountval'+arrb[ii]+'" ><input type="hidden" id="totamt'+ii+'" value="'+ttt[ii]+'"></td><td class="pp_ttl txt_rt" id="totamtval'+ii+'" >'+ttt[ii]+'</td></tr><tr><td colspan="4" class="prd_b_tb"><div id="prds_tbl'+index+'" class="collapse tgl_div"><table><tr><th class="brnd_ane"> Product Name </th><th class="pp_amnt txt_rt"> MRP </th><th class="pp_dis"> Discount </th><th class="pp_ttl txt_rt"> Total </th></tr><tbody id="productssata'+index+arrb[ii]+''+trades.category+'"></tbody>';
