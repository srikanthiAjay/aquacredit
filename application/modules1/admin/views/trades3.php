		...
		success : function(response){
			...
			if(res.data.length > 0)
			{
				$.each(res.data, function(index, brand) {
					...
					{
						opt += '<div class="form-check"><input class="form-check-input" type="checkbox" name="traderval" value="' + brand.td_id + '" id="trdd'+brand.td_id+'"><label class="form-check-label" for="trdd'+brand.td_id+'">' + brand.full_name + '</label></div>';
					}
					else
					{
