...
<div class="right_blk">
	<div class="top_ttl_blk"> 
		<span class="back_btn"> 
		<!-- <a href="<?php echo base_url();?>admin/brands" title=""><img src="<?php echo base_url();?>assets/images/back.png" alt="" title=""> </a> --></span> <span> Brand Detail</span>

		<a href="<?php echo base_url();?>admin/brands/edit/<?php echo $bdata["brand_id"];?>" title="" class="btn ed_usr btn-primary fr"> Edit Brand </a>
	</div>
		...
		<div class="row">
			<div class="col-md-12 ll_blk">
				<div class="card_view mar_btm">
					<div class="pad_20"> 
						<div class="hdg_bk">Brand Details </div>
						<div class="row"> 
						<div class="col-md-6"> <b>Brand Name:</b> </div>
