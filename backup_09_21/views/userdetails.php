          ...
          <div class="row">
              <div class="col-md-6" id="feedharvestsymbol"> 
                <div class="rat_blk"> 
                    ...
                    <img class="grt_rto_img" src="http://3.7.44.132/aquacredit/assets/images/grt_rto" alt="" title="">
                     <img class="lss_rto_img" src="http://3.7.44.132/aquacredit/assets/images/lss_rto" alt="" title="">
                      <img class="eql_rto_img" src="http://3.7.44.132/aquacredit/assets/images/eql_rto_rto" alt="" title="">
