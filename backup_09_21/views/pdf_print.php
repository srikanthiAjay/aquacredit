...
<body style="padding: 0px; margin: 0px; font-family: arial;">
    ...
    <table cellpadding="5" cellspacing="0" border="0" style="width: 100%; border: 1px solid #ccc;">
        <td> 
            <div style="font-size: 12px;font-weight: normal; line-height: normal; margin: 0px; padding: 0px;"> Srikanthi Akula - #FS012020 
            <div style="font-size: 11px; margin: 0px; line-height: normal; padding-top: 0px;"> 9553377838  </div>
             </div> </td>
             <td style="text-align: right;">
                ...
                <tbody><tr> 
                    <td style="padding-right: 20px"> 
                        ...
                        <div style="font-size: 12px; padding: 0px; font-weight: normal;margin: 0px; margin-bottom:0px; line-height: normal; text-align: center;"> Bhimavaram
                </div>
                </div>
                    </td>
                    <td style="border-left: 1px solid #e9e6e5; padding-left: 20px;"> 
                        ...
                        <div style="font-size: 12px; font-weight: normal;margin: 0px; margin-bottom:0px; padding: 0px; line-height: normal; text-align: center;"> 17-Sep-2020
                </div>
                </div>
                    </td>
                </tr>
        ...
        <tr> 
            <td style="text-align: center; width: 50%; border: 1px solid #ccc;" align="center"> 
                ...
                <tbody><tr> <td style="text-align: center;"> 
                    <div style="padding: 0px 0px; position: relative; top: -40px; font-size: 10px; display: inline-block; text-align: center;"> Harvest <input type="hidden" name="harvesttonsval" id="harvesttonsval" value="0.01"> 
                        <div style="margin: 0px; padding: 0px; font-size: 12px;position: relative;top: 0px;   width: 100%;display: block;"> 0.01 </div>
                    </div> </td> 
                    <td style="text-align: center;"> 
                        <div style="width: 175px; display: inline-block; position: relative;height: 95px;    text-align: center;"> <img style="display: inline-block;" src="http://3.7.44.132/aquacredit/assets/images/grt_rto" alt="" title=""> 
                                <div style="width: 100%; text-align: center; font-size: 12px;  margin-top: 10px;">  FCR: <span style=""> 1:0 </span> 
                                     <div style="text-align: center; width: 100%;"> Good </div>
                                </div>

                            </div>
                    </td>
                    <td style="text-align: center;"> <div style="padding: 0px 0px; position: relative; top: -40px; font-size: 10px; display: inline-block; text-align: center;"> Harvest <input type="hidden" name="harvesttonsval" id="harvesttonsval" value="0.01"> 
                        <div style="margin: 0px; padding: 0px; font-size: 12px;position: relative;top: 0px;   width: 100%;display: block;"> 0.01 </div>
                    </div> </td>
                </tr>
            </tbody></table>
