...
class Users extends CI_Controller 
{
	...
	public function ajax_refresh($utype)
	{
		if($utype=='FARMER'){
			$this->load->view('admin/user/editfarmer1',$data);
		}else if($utype=='DEALER'){
			$this->load->view('admin/user/editdealer1',$data);
		}else{
			$this->load->view('admin/user/editnonformer1',$data);
		}
	}	
}
?>