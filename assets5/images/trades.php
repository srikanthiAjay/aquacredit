...
<style>
	...
	border-top-right-radius: 5px; transform: perspective(5px) rotateX(0.93deg) translateZ(-1px); transform-origin:0 0; content: ' ';  height: 57px; width: 96px; background: #007bff;}
	...
	.tabs_tbl.cmp_ul:after {left: 84px; width: 106px;}
 ...
 */
	...
	$('#usr_lst_tbl_wrapper .dataTables_length').html('<ul class="tabs_tbl"><li class="act_tab drft_cl"> <span>Drafts</span> </li><li class="comp_cl"> <span> Completed </span> </li></ul> <span class="tbl_btn">  </span>');
			...
			<form id="tradefrm_edit_exp" name="tradefrm_edit_exp" action="javascript:void(0);" method="post">
				<div class="top_no_txt">
					...
					<div class="edt_bl_lnk">
						...
						<img src="http://3.7.44.132/aquacredit/assets/images/edit.svg" alt="" title="">
						Edit</span>
