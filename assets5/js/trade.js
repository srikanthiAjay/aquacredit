    ...
    $(document).on("click", ".trade_btn", function() {
        ...
        $('#tradefrm').validate({
            ...
            showErrors: function(errorMap, errorList) {
                ...
                $("#crps").css("border", "").removeClass("error").tooltip("dispose");
                // Create new tooltips for invalid elements
                $.each(errorList, function(index, error) {
                    var $element = $(error.element);
                    if (error.method == "crop_location") {
                        console.log(error.message);
                        $("#crps").css("border", "1px solid red");
                        $("#crps").tooltip("dispose").data("title", error.message).data("placement", "bottom").addClass("error").tooltip({
                            onShow: function() {
                                console.log('tooltip');
                        ...
                        $element.tooltip("dispose").data("title", error.message).data("placement", "bottom").addClass("error").tooltip({
                            onShow: function() {
                                console.log('tooltip');
                                this.getTrigger().fadeTo("slow", 0.8);
                            }
            ...
            /* errorPlacement: function(error, element) {
                ...
                console.log(element);
                $(".error").parent().addClass("cre_error");
                $(".valid").parent().addClass("cre_valid");
                return false;
            }, */
            ...
            /*  errorPlacement: function(error, element) {
                 ...
                 $(".mykey").each(function() {
                     if ($(this).hasClass("error")) {
                         $(this).parent().addClass("cre_error");
                     } else if ($(this).hasClass("valid")) {
                         $(this).parent().addClass("cre_valid");
                     }
